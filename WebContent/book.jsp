...
.my_bg {
    background-image: url("https://media.istockphoto.com/id/854608904/ko/%EB%B2%A1%ED%84%B0/%ED%95%98%EC%96%8F%ED%8A%B8-%EB%A6%AC%EC%A0%A0%EC%8B%9C-%ED%9E%90-%EC%BB%A8%ED%8A%B8%EB%A6%AC-%EB%A6%AC%EC%A1%B0%ED%8A%B8-%EC%95%A4-%EC%8A%A4%ED%8C%8C.jpg?s=612x612&w=0&k=20&c=Zxef3mqauB07jeo5ESOTXlI3JUDv5oi-WYk0_JTYIpo=");
}</style>
<body>
<!-- Navigation-->
                  ...
                  <c:forEach var="cnt" begin="1" end="${count}" step="1">  
                    ...
                    <div class="col mb-5">
                        <div class="card h-100">
                            <!-- Product image-->
                            <a href="item.do?pname=<%=(String) session.getAttribute("bname"+ String.valueOf(count))%>">
                            <img class="card-img-top" src=<%=(String) session.getAttribute("bimg"+ String.valueOf(count))%> width="350", height="400" />
                            <!-- Product details--></a>
                            <div class="card-body p-4">
                                <div class="text-center">
                                    <!-- Product name-->
                                    <h5 class="fw-bolder">조회수 Top <%= count %>. </br></br><a href="item.do?pname=<%=(String) session.getAttribute("bname"+ String.valueOf(count))%>" style="color: black; font-weight: 100; text-decoration: none;"><%=(String) session.getAttribute("bname"+ String.valueOf(count))%></a></h5>
                                     <!-- Product price-->
                                   
                                    </br><font size="4em"><b><%=(Integer) session.getAttribute("bprice"+ String.valueOf(count)) %>원</b></font></br>
                                    
                                </div>
                                 <div class="d-flex justify-content-center small text-warning mb-2">
                                        <div class></br>조회수 <%=(Integer) session.getAttribute("bviews"+ String.valueOf(count)) %> 회</div>
