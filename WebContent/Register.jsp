...
<body>
<form class="joinForm"  action = "register.do">
      ...
      <div class="textForm">
       ...
       <div class="textForm">
        <input name="address" type="text" class="name" placeholder="주소">
      </div>
      <div class="textForm">
      ...
      <button type="submit" style="background-color: #ff4261; color: white; border: none; padding: 10px 10px;"
      >가입하기</button>
